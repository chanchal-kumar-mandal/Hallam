...
$result = mysqli_query($db->db_conn, "SELECT * FROM tasks WHERE is_task_completed = 'Yes'AND task_action_date LIKE '%-".$task_completion_month."-%'");
?>            

        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-center">Completed Tasks In
                        <select class="btn-lg btn-group text-danger" id="taskCompletionMonthInCompleted" name="task_completion_month">
                            <?php
