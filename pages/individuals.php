...
$result = mysqli_query($db->db_conn, "SELECT * FROM individuals WHERE requires_tax_return = 'No' AND on_stop = 'No'");
?>            

        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-center">Individuals</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="odd gradeA">
                                                ...
                                                <td class="text-center">
                                                    <a class="btn-xs btn-warning" href="edit-individual.php?id=<?php echo $row["id"]; ?>"><i class="fa fa-edit"></i> Edit</a>
                                                    <a class="btn-xs btn-primary" href="individual.php?id=<?php echo $row["id"]; ?>"><i class="fa fa-eye"></i> View</a>
                                                    <a class="btn-xs btn-danger" onclick="deleteContent(<?php echo $row["id"]; ?>, 'individual')" href="javascript:void(0)"><i class="fa fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                            }                                            
