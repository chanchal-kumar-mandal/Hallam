...
?>            
        ...
        if($resultVat->num_rows > 0){  
            ...
            ?>           
               <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-center">Individual VAT</h1>
                </div>
                <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6"> 
                                            <p>
                                                <b>Individual : </b>
                                                <?php
                                                    $result = mysqli_query($db->db_conn, "SELECT * FROM individuals WHERE id = ".$rowVat['individual_id']);
                                                    if($result->num_rows > 0){
                                                        while($row = $result->fetch_array()){
                                                            echo '<a href="individual.php?id='.$row["id"].'" target="_blank">'.$row["firstname"].' '. $row["surname"].'</a>';
                                                        }                                            
                                                    }else{
                                                        echo 'No Individual';
                                                    }
                                        ...
                                        <div class="col-lg-12 text-center"> 
                                            <a href="edit-individual-vat.php?id=<?php echo $rowVat['id']?>" class="btn btn-danger"><i class="fa fa-edit"></i> Edit</a>
                                        </div>
                                        <!-- /.col-lg-12 -->
                                    </div>
                                    <!-- /.row --> 
