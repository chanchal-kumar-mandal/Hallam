...
$result = mysqli_query($db->db_conn, "SELECT * FROM tasks");
?>            
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="odd gradeA">
                                                ...
                                                <td class="text-center">
                                                    <a class="btn-xs btn-warning" href="edit-task.php?id=<?php echo $row["id"]; ?>"><i class="fa fa-edit"></i> Edit</a>
                                                    <a class="btn-xs btn-primary" href="task.php?id=<?php echo $row["id"]; ?>"><i class="fa fa-eye"></i> View</a>
                                                    <a class="btn-xs btn-danger" onclick="deleteContent(<?php echo $row["id"]; ?>, 'task')" href="javascript:void(0)"><i class="fa fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                            }                                            
