...
$result = mysqli_query($db->db_conn, "SELECT * FROM individuals WHERE vat_registered = 'Yes' order by firstname, surname");
?>            

        <div id="page-wrapper">            
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-center">Add Individual VAT</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <form role="form" id="addIndividualVatForm">
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="row">                                    
                                    <div class="col-lg-6 col-md-offset-3">
                                        ...
                                        <div class="col-lg-12 text-center">            
                                            <button type="submit" id="addIndividualVatSubmitButton" class="btn btn-danger"><i class="fa fa-send"></i> Submit</button>
