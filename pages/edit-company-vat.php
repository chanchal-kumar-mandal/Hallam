...
?>            
        ...
        <div id="page-wrapper">            
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-center">Edit Company VAT</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <form role="form" id="editCompanyVatForm">
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="row">                                    
                                    <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                if($result->num_rows > 0){
                                                    while($row = $result->fetch_array()){
                                                        echo '<option value="'.$row["id"].'" '.(($row["id"] == $rowVat["company_id"])? "selected" : "").'>'.$row["company_name"].'</option>';
                                                    }                                            
                                                }else{
                                            ...
                                            if(count($vat_submitted_to_hmrc_quarters_years) > 0){
                                                ...
                                                foreach($vat_submitted_to_hmrc_quarters_years as $index => $vat_sumission_quarter){
                                                    ...
                                                    if(count($quarters_submitted_in_db) > 0){
                                                        if(isset($quarters_submitted_in_db[$quarters_count])){
                                        ...
                                        <div class="col-lg-12 text-center">            
                                            <button type="submit" id="editCompanyVatSubmitButton" class="btn btn-danger"><i class="fa fa-send"></i> Submit</button>
                                        </div>
                                        <!-- /.col-lg-12 -->  
                                    <?php
                                    }
